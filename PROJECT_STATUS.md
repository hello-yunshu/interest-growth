...
- DB + Source + Artifact backup/restore bundle tooling: implemented, with a required quiesced-write operational boundary.
- Docker API/Web images: build and boot; health/capability/Web return 200 and an unauthenticated protected route returns 401.
- Gate B remains open for atomic concurrent refresh consumption, database-enforced owner singleton, online backup locking and rollback-safe restore.
...
- merged Host/native regression suite: **192 tests PASS**;
- standalone Native Execution Core verification: **70 tests PASS**;
...
- fresh DB includes 2 Domain Packs, 1 default Psychology Area, scoped Personas and migrations 1–12;
