...
- 2026-08-14 full regression: 244 pytest passed, Native Core standalone PASS, 59 ClientRuntime JS tests + 7 controller tests passed, 44 Rust tests passed (runtime-mode + native remote broker integration), Web lint/static build passed, all Host gate scripts PASS (`scripts/verify.py` version check synced to 0.7.0, SOURCE_MANIFEST integrity check PASS with the manifest regenerated for the changed native-broker/web files), RAG upstream pin re-verified exact.
