...
records, not current-SHA PASS claims. Exact current-SHA evidence is generated by
the tag workflow and must not be hardcoded into this source status document.
