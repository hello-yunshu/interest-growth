  ...
  return <div className="stack">
    ...
    <div className="card">
      <div className="fieldGroup">
        ...
        <select value={topicId} onChange={e=>setTopicId(e.target.value)}><option value="">不绑定 Topic</option>{topics.map(t=><option key={t.id} value={t.id}>{t.title}</option>)}</select>
