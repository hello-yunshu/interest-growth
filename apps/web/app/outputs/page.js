...
export default function OutputsPage() {
  ...
  return <div className="outputsPage stack">
    ...
    <section className="outputLibrary">
      <div className="libraryHeader"><div><span className="sectionKicker">全部记录</span><h2>浏览学习成果</h2></div><label className="inlineSearch"><Icon name="search"/><input value={query} onChange={event => setQuery(event.target.value)} placeholder="搜索成果" aria-label="搜索成果"/></label></div>
