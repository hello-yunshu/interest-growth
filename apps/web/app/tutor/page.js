...
export default function TutorPage(){
  ...
  return <div className="stack">
    <section className="pageLead"><div><div className="eyebrow">导师 · {areaName}</div><h1>带着一个具体问题，继续上次的思路。</h1><p className="muted">导师会结合当前兴趣的学习方式和你选中的资料。界面只呈现可检查的活动、工具与来源。</p></div><div className="pageLeadStatus"><StatusChip tone={connected?'success':'neutral'} pulse={running}>{connected?'已连接':'尚未连接'}</StatusChip></div></section>
