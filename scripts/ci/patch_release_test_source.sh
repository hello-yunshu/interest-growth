...
'        // Match the current CI-only Android verifier: use the injected CA as\n'
'        // an isolated trust store. Merging it into the historical Android\n'
'        // verifier can make reqwest fail during client construction.\n'
